...
class AgentObserver: public MAgentObserver
{
	...
	virtual TBool OnCompChanged(const MUnit* aComp, const string& aContName = string(), TBool aModif = EFalse) override { return EFalse;}
	virtual TBool OnChanged(const MUnit* aComp) override { return EFalse;}
	virtual TBool OnCompRenamed(const MUnit* aComp, const string& aOldName) override { return EFalse;}
