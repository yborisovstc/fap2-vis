...
ASystDrp::ASystDrp(const string& aName, MUnit* aMan, MEnv* aEnv): AUnitDrp(aName, aMan, aEnv)
{
    iName = aName.empty() ? GetType(PEType()) : aName;
}

string ASystDrp::PEType()
{
    return AUnitDrp::PEType() + GUri::KParentSep + Type();
}
